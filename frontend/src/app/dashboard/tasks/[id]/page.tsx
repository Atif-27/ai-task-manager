...
import DeleteOverloay from "@/components/dashboard/DeleteOverloay";
        ...
        <CardHeader>
          <div className="flex items-start justify-between">
            ...
            <div className="flex gap-2">
              ...
              >
                <DeleteOverloay id={task.id} redirect={true}>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              task.assigned_to_details.length > 2 ? (
                <Popover>
                  <PopoverTrigger>
                    <Button variant="outline">View Assignees</Button>
                  </PopoverTrigger>
                  <PopoverContent className="space-y-2">
                    {task.assigned_to_details.map((user) => (
          ...
          <Card className="bg-primary/5 border-primary/20 animate-fade-in">
            ...
            <CardContent>
              <Button
                variant="outline"
                className="w-full justify-start gap-2 transition-all duration-300 hover:bg-primary/10"
              >
